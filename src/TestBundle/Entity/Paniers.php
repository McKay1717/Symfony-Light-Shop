...
class Paniers {
	/**
	 *
	 * @var integer @ORM\Column(name="quantite", type="integer", nullable=false)
	...
	/**
	 *
	 * @var \DateTime @ORM\Column(name="dateAjoutPanier", type="datetime", nullable=false)
	 *      @Assert\DateTime()
	 *      @Assert\NotNull()
	 */
	...
	/**
	 *
	 * @var \TestBundle\Entity\Produits @Assert\Valid()
	 *      @Assert\NotNull()
